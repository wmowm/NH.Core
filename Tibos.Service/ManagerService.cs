...
namespace Tibos.Service
{
	...
	{
		private readonly IManager dao;
        public ManagerService(IManager dao)
		{
            this.dao = dao;
        }
        ...
        public IList<Manager> GetList(Expression<Func<Manager, bool>> expression, List<SortOrder<Manager>> expressionOrder, Pagination pagination)
        {
        ...
        /// <returns></returns>
        public string Save(Manager model) 
        {
